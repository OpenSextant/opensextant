...
public abstract class AppBase {
    ...
    /** The controller manages insertion of data into the GATE pipeline
     *  execution and retrieval of results from the pipeline.
     */
   ...
   /** If you need a special GAPP -- that is not the standard production GAPP
     ...
     * before anything else.  And then most initialization follows the SimpleGeocoder 
     * logic at least: setup your GAPP and a few other resources.
     * The OpenSextantRunner is a more complete document processing pipeline.
     * 
     * Both are examples of complete geocoders -- as you implement your own
     * you may choose to extend either of these ore create your own from AppBase
     * 
     * 
     */
